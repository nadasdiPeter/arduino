...
#define motor_speed_maximum             255u
#define motor_speed_standstill          0u
...
#define SERIAL_COM_COMMAND__fca                         (char)0x66    /* Asci code: f */ // FCA: Forward Collision-Avoidance Assist
