...
namespace CarController
{
   public partial class MainWindow : Window
   {
      ...
      {
         if (stop_btn == sender) HandleHttpGetRequests(new Command(Configuration.COMMAND__stop));
         else if (forward_button == sender) HandleHttpGetRequests(new Command(Configuration.COMMAND__forward));
         else if (backward_btn == sender) HandleHttpGetRequests(new Command(Configuration.COMMAND__backward));
         else if (left_btn == sender) HandleHttpGetRequests(new Command(Configuration.COMMAND__left));
         else if (right_btn == sender) HandleHttpGetRequests(new Command(Configuration.COMMAND__right));
         else if (light_btn == sender) HandleHttpGetRequests(new Command(Configuration.COMMAND__headlight));
         else if (info_btn == sender) HandleHttpGetRequests(new Command(Configuration.COMMAND__lcd_info));
         else if (turn_btn == sender) HandleHttpGetRequests(new Command(Configuration.COMMAND__turn_mode));
         else if (fca_btn == sender) HandleHttpGetRequests(new Command(Configuration.COMMAND__fca));
      }
   }
}
